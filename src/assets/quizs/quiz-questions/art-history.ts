...
export const questions: QuizModel.Question[] = [
    ...
    {
        question: "Which artist created the sculpture David that stands in Florence's Accademia Gallery?",
        options: [
            "Michelangelo",
            "Donatello",
            "Bernini",
        ...
        answer: 0,
        explanation:
            "Michelangelo's David was completed in the early 16th century and is one of the most famous sculptures of the Renaissance.",
        level: 2,
    },
    {
    ...
    {
        question: "Which artist is associated with the painting American Gothic?",
        options: [
            "Grant Wood",
            "Edward Hopper",
            "Jackson Pollock",
        ...
        answer: 0,
        explanation:
            "American Gothic was painted by American artist Grant Wood in 1930.",
        level: 2,
    },
    ...
    {
        question: "Which artist created the monumental sculpture The Ecstasy of Saint Teresa?",
        options: [
        ...
        answer: 0,
        explanation:
            "Bernini created The Ecstasy of Saint Teresa during the Baroque period. It is located in the Cornaro Chapel in Rome.",
        level: 3,
    },
    {
        question: "Which artist is associated with the technique of pointillism?",
        options: [
            "Georges Seurat",
            "Claude Monet",
            "Paul Cézanne",
        ...
        answer: 0,
        explanation:
            "Georges Seurat developed pointillism, using small distinct dots of colour that blend visually when viewed from a distance.",
        level: 3,
    },
    {
