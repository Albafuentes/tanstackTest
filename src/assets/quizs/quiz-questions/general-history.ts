...
export const questions: QuizModel.Question[] = [
    ...
    {
        question: "Which civilization is famous for developing democracy in ancient Athens?",
        options: [
            "The Greeks",
            "The Romans",
            "The Egyptians",
    ...
    {
        question: "Who was the British monarch during most of the Second World War?",
        options: [
            "George VI",
            "Edward VIII",
            "George V",
    ...
    {
        question: "Which event is traditionally considered the beginning of the French Revolution?",
        options: [
    ...
    {
        question: "Which civilization developed the famous road network known as the Qhapaq Ñan?",
        options: [
            "The Inca",
            "The Maya",
            "The Aztecs",
    ...
    {
        question: "Which treaty officially ended World War I between Germany and the Allied Powers?",
        options: [
    ...
    {
        question: "Which explorer led the expedition that completed the first circumnavigation of the Earth?",
        options: [
            "Ferdinand Magellan",
            "Christopher Columbus",
            "James Cook",
    ...
    {
        question: "Which ancient civilization used a writing system known as cuneiform?",
        options: [
            "The Sumerians",
            "The Vikings",
            "The Aztecs",
    ...
    {
        question: "Which Roman city was buried alongside Pompeii after the eruption of Mount Vesuvius?",
        options: [
            "Herculaneum",
            "Florence",
            "Ravenna",
    ...
    {
        question: "Which ancient civilization is credited with developing the first known alphabetic writing system?",
        options: [
            "The Phoenicians",
            "The Romans",
            "The Persians",
    ...
    {
        question: "Which Byzantine emperor ordered the construction of Hagia Sophia in its famous sixth-century form?",
        options: [
            "Justinian I",
            "Constantine XI",
            "Theodosius I",
    ...
    {
        question: "Which agreement divided newly discovered overseas territories between Spain and Portugal in 1494?",
        options: [
    ...
    {
        question: "Which battle in 732 is traditionally associated with Charles Martel stopping the Umayyad advance into Frankish territory?",
        options: [
            "Battle of Tours",
            "Battle of Hastings",
            "Battle of Agincourt",
    ...
    {
        question: "Which Roman emperor made Christianity legal throughout the Roman Empire through the Edict of Milan?",
        options: [
            "Constantine I",
            "Nero",
            "Augustus",
    ...
    {
        question: "Which dynasty ruled China during the construction of much of the Forbidden City?",
        options: [
            "Ming dynasty",
            "Han dynasty",
            "Tang dynasty",
    ...
    {
        question: "Which medieval document limited the power of the English king John in 1215?",
        options: [
            "Magna Carta",
            "Domesday Book",
            "Bill of Rights",
    ...
    {
        question: "Which ancient city was the capital of the Achaemenid Persian Empire and home to the famous Apadana?",
        options: [
            "Persepolis",
            "Babylon",
            "Sparta",
